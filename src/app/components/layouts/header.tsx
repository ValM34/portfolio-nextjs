...
export default function Header() {
  return (
    <nav className="flex justify-evenly bg-gradient-to-r from-indigo-500 to-indigo-300">
      ...
      <Link className="hover:scale-110 transition-transform text-center text-2xl font-medium p-4" href="/project">Mes projets</Link>
